...
import DetailRowView from './components/PersonDetail/PersonDetail';
import ModeSelector from './components/ModeSelector/ModeSelector';
import TableSearch from './components/TableSearch/TableSearch';
import RowColSelect from './components/RowColSelect/RowColSelect';
    ...
    if(!this.state.isModeSelected){
      return (
        <div className="container">
          ...
          <RowColSelect selectMethod={this.gettingRows}/>
        </div>
